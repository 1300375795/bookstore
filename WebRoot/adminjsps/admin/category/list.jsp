		...
		<c:forEach items="${parents }" var="parent">
			<tr class="trOneLevel">
				...
				<td width="200px;">
					...
					href='<c:url value="/admin/AdminCategoryServlet?method=removeParent&cid=${parent.cid  }"></c:url>'>删除</a></td>
			</tr>
			<c:forEach items="${parent.children}" var="child">
				<tr class="trTwoLevel">
					...
					<td width="200px;" align="right"><a
						...
						href="<c:url value='/admin/AdminCategoryServlet?method=removeChild&cid=${child.cid }'/>">删除</a></td>
				</tr>
			</c:forEach>
		</c:forEach>
	</table>
